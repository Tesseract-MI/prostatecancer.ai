...
function resultDataToStudyMetadata(server, studyInstanceUid, resultData) {
    ...
    resultData.forEach(function(instance) {
        ...
        var instanceSummary = {
            ...
            imageOrientationPatient: DICOMWeb.getString(instance['00200037']) || instance['52009229']['Value'][0]['00209116']['Value'][0]['00200037']['Value'][0],
            ...
            pixelSpacing: DICOMWeb.getString(instance['00280030']) || instance['52009229']['Value'][0]['00289110']['Value'][0]['00280030']['Value'][0],
            ...
            sliceThickness: DICOMWeb.getNumber(instance['00180050']) || instance['52009229']['Value'][0]['00289110']['Value'][0]['00180050']['Value'][0],
